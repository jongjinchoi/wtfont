...
- ✓ Future npm releases are configured to use **npm provenance attestations** through GitHub Actions. No npm release has been published yet.
- ✗ Does **not** sandbox itself — if you don't trust the package, don't install it. Verify integrity before upgrading.

Check releases at https://github.com/jongjinchoi/wtfont/releases before upgrading.
